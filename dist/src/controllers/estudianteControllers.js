...
exports.remove = exports.put = exports.getById = exports.getAll = exports.create = void 0;
...
const create = (estudiante, callback) => {
    ...
    db_1.db.query(queryString, [estudiante.cod_e, estudiante.nom_e, estudiante.dir_e, estudiante.tel_e, estudiante.fech_nac], (err) => {
        ...
        const query = `
            UPDATE estudiantes 
            SET nom_e = ?, dir_e = ?, tel_e = ? 
            WHERE cod_e = ?;
        `;
        db_1.db.query(query, [estudiante.nom_e, estudiante.dir_e, estudiante.tel_e, estudiante.cod_e]);
        callback(null, {
            statusCode: 201,
...
const put = (cod_e, estudiante, callback) => {
    const queryString = 'put estudiantes SET nom_e = ?, dir_e = ?, tel_e = ?, fech_nac = ? WHERE cod_e = ?';
